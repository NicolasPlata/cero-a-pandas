...
### Duración estimada por nivel de proyecto (Módulo 9)

| Nivel | Proyectos | Horas por proyecto | Horas totales del nivel |
|-------|-----------|----------------------|----------------------------|
| 🟢 Nivel 0 — Fundamentos de Python | 1-3 | 2-4 h | 6-12 h |
| 🟢 Nivel 1 — Primeros Pasos con Pandas | 4-5 | 3-5 h | 6-10 h |
| 🟡 Nivel 2 — Limpieza, Transformación y EDA | 6-9 | 6-12 h | 24-48 h |
| 🟡 Nivel 3 — Operaciones Avanzadas | 10-12 | 8-12 h | 24-36 h |
| 🔴 Nivel 4 — Estadística y Machine Learning | 13-15 | 8-15 h | 24-45 h |
| 🔴 Nivel 5 — Producción y Dominios Especiales | 16-18 | 10-18 h | 30-54 h |
| 🔴🔴 Capstone | 19 | 8-10 h | 8-10 h |

Si el tiempo apremia, prioriza los ítems de prioridad **Alta** del backlog de cada proyecto
(están marcados explícitamente en cada capítulo) y trata las extensiones opcionales como lo
que son: opcionales. Resolver bien las historias de prioridad Alta de 10-12 proyectos bien
elegidos vale más que completar los 19 de forma apresurada.
...
| Después de... | Ya puedes intentar |
|----------------|------------------------|
| **Módulo 1.1** (Fundamentos de Python) | Proyectos 1-3 (Nivel 0) |
