# 🟢 Nivel 1 — Primeros Pasos con Pandas

**Requiere:** [Módulo 2: Introducción a Pandas](../../02-introduccion-pandas/00-intro.md).
**Duración estimada del nivel:** 6-10 horas (3-5 h por proyecto).

Grano de Datos migra del cuaderno en Python puro (Nivel 0) a `pandas` de verdad. Estos dos
proyectos retoman directamente el inventario que ya construiste, ahora como `DataFrame`.
