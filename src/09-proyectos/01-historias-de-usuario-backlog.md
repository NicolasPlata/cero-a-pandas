...
inversionista — eso afecta cuánto detalle técnico incluir), **qué** exactamente quiere (semanal,
por producto — no "ventas en general"), y **para qué** (decisiones de reabastecimiento — eso te
dice que la fecha y la cantidad importan más que, por ejemplo, el método de pago usado).
