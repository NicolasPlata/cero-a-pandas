...
1. Fase 9F: Proyectos 13-15 (Nivel 4, estadística y machine learning).
2. Continuar fases 9G-9I en el orden del plan de expansión (`docs/plan-expansion-modulo9.md`).
